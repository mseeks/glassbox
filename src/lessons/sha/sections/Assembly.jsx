    ...
    <section ref={ref}>
      <div className="sha-wrap">
        <SectionHead
          ...
          lede={
            <>
              ...
              . Picture a factory line: down it travels a single 256-bit workpiece. Each station
              grabs one block of your message, stamps it into the workpiece, and passes it on. The
              last station hands you the finished piece: your hash.
            </>
          }
        />
        ...
        <p className="body">
          ...
          original length. That trailing length is not decoration. It guarantees two messages of
          different sizes can never produce the same padded stream, which collision resistance
        ...
        <p className="body">
          ...
          the running state (without that feedback the whole thing would be reversible and useless).
          Then the next block comes through. Sixty-four rounds of mixing happen inside each stamp,
          and that mixing is where the avalanche is born.
        </p>
      </div>
    </section>
  );
