    ...
    <Movement id="rum" dark>
      ...
      <Prose style={{ marginBottom: 26 }} dropcap>
        <p>
          ...
          minimises all three at once. Read-amp is the cost of looking. Update-amp is the cost of
          rewriting a byte over its life. Memory-amp is the extra storage carried in dead versions,
          in tombstones, in indexes. The three are not independent. They lie on a surface.
        </p>
        <p>
          ...
          reads. Drag the point and feel the surface push back. Your workload tells you which corner
          you want. The surface tells you the toll.
        </p>
      </Prose>
      <RumLab />
    </Movement>
