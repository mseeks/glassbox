    ...
    <Section roman="I" kicker="The problem" title="A billion keys, kept in order">
      <Reveal base="bt-rev">
        <p className="bt-lead">
          ...
          look one up fast, and walk them <span className="bt-em">in order</span>, every name
      ...
      <Reveal base="bt-rev">
        <p className="bt-p">
          On disk, the unit of cost isn&rsquo;t comparing two keys. It&rsquo;s fetching a{' '}
      ...
      <Reveal base="bt-rev">
        <p className="bt-p">
          ...
          <strong>thirty levels</strong> deep, each living at some unpredictable address. That is
      ...
      <Callout title="The one hardware fact">
        ...
        enormously: drag the branching factor below and watch thirty levels collapse into three.
      </Callout>
      ...
      <Reveal base="bt-rev">
        <p className="bt-p">
          A binary node holds one key and two pointers, a few bytes, and then pays a full page fetch
          to read them. A forklift trip for a nearly empty pallet. So stuff the node until it fills
          the page: at about sixteen bytes per key-and-pointer, a four-kilobyte page holds a couple
          hundred keys and fans out a couple hundred ways.{' '}
          <strong>That single decision is the entire B-tree.</strong>
        </p>
      </Reveal>
      <Reveal base="bt-rev">
        <p className="bt-p">
          It never got a smarter algorithm than the binary tree. Same comparisons, same logarithmic
          complexity. It just chose a <span className="bt-em">base</span> for that logarithm to
          match the hardware, collapsing thirty levels into three or four. The{' '}
          <span className="bt-stampc">B</span> most likely stands for{' '}
          <span className="bt-em">balanced</span>, from Bayer and McCreight in 1970, who coyly never
          said so.
        </p>
      </Reveal>
    </Section>
