    ...
    <Section roman="VII" kicker="The decision" title="A B-tree, or its mirror image">
      <Reveal base="bt-rev">
        <p className="bt-p">
          ...
          <span className="bt-stampc">random-write amplification</span> that LSM trees sprint away
          from. Read it the other direction. Those few, shallow levels that cost a B-tree on writes
          are exactly what give it unbeatable three-or-four-seek reads. Same tradeoff, opposite
          ends. Which is why a storage engineer&rsquo;s first real decision is often just{' '}
