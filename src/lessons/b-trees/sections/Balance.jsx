    ...
    <Section roman="IV" kicker="Balance" title="Why a tree wants to lean">
      <Reveal base="bt-rev">
        <p className="bt-p">
          ...
          arrive already sorted and every key goes right, right, right. You don&rsquo;t get a tree,
          you get a <span className="bt-stampc">vine</span>. Depth piles up on one side while the
          other stays empty; the promised bushy, shallow shape becomes a single dangling string.
          That is imbalance.
        </p>
      </Reveal>
      <ImbalanceVisual />
      <Reveal base="bt-rev">
        <p className="bt-p">
          ...
          neighbors beneath. AVL and red-black trees do this on every insert: let imbalance happen,
          detect it locally, pivot it away. Reactive and logarithmic, exactly what you want for an
          in-memory map. But here a node is a four-kilobyte page; rotating on every insert is the
          page-thrashing we&rsquo;re trying to avoid.
        </p>
      </Reveal>
      <Reveal base="bt-rev">
        <p className="bt-lead">
