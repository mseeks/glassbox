    ...
    <section id="s2" className="vp-section">
      ...
      <Reveal base="rv" className="vp-prose">
        <p>
          ...
          does? Because those structures rest on a <strong>total order</strong> — the ability to
          say, for any two items, that one comes “before” the other, consistently. Numbers have it.
          Words have it. That single guarantee is what lets a search tree split its data into “less”
          and “greater” and discard half at every step.
        </p>
