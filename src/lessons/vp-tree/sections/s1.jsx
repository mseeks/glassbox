    ...
    <section id="s1" className="vp-section">
      ...
      <Reveal base="rv" className="vp-prose">
        <p>
          ...
          position you care about — and you want the single closest contact to it. The catch that
          shapes everything: you have no map and no coordinates. The only operation available is a{' '}
          <span className="ping">range measurement</span> — given two things, how far apart are
          they.
        </p>
        ...
        <div className="vp-defn">
          ...
          distances are never negative, the distance from a thing to itself is zero, distance is
          symmetric, and — crucially — it obeys the triangle inequality. Coordinates optional; only
          distances are required.
        </div>
        <p>
          The obvious method is to measure the range to every contact and keep the smallest. It
          always works, and it is the baseline we want to beat. Run it below and watch the cost:
          with <span className="hl">N</span> contacts, every query costs{' '}
          <span className="hl">N</span> measurements.
        </p>
      </Reveal>
      <Reveal base="rv">
        <BruteForceLab />
