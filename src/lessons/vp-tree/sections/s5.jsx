    ...
    <section id="s5" className="vp-section">
      ...
      <Reveal base="rv" className="vp-prose">
        ...
        <p>
          ...
          lower bound already exceeds our current best, the entire region — all its contacts, all
          its sub-regions — <span className="coral">is pruned</span>, skipped without a single
      ...
      <Reveal base="rv" className="vp-prose">
        <p style={{ marginTop: 22 }}>
          ...
          the answer is always the true nearest neighbour — identical to brute force, reached at a
