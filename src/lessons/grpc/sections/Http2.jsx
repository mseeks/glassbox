        ...
        <div className="gx-prose">
          <Reveal base="gx-fade">
            ...
            <p>
              ...
              a single connection. Toggle the two transports and play it:
            </p>
          </Reveal>
          <Reveal base="gx-fade">
            <MultiplexScope />
          ...
          <Reveal base="gx-fade">
            <p style={{ marginTop: 28 }}>
              ...
              frames; and the final status arrives in <strong>trailers</strong> — a second header
              block sent after the body, which is what lets a server stream results before it knows
              the outcome.
            </p>
          </Reveal>
          <Reveal base="gx-fade">
          ...
          <Reveal base="gx-fade">
            <Callout kind="info">
              ...
              <em>in the application</em>, but all those streams still ride one TCP connection — so
              a lost packet can still stall every stream at the TCP layer. HTTP/3 moves gRPC onto
              QUIC (over UDP) to close that last gap.
            </Callout>
          </Reveal>
        </div>
      </div>
