    ...
    <section className="hero">
      <div style={{ maxWidth: '920px', margin: '0 auto', width: '100%' }}>
        ...
        <p className="hero-subtitle">
          Concurrent programs are not hard because there are more lines of code. They are hard
          because more than one thing can observe the same state at the same time. This lesson
          builds the mental model from the ground up: interleaving, synchronization, async runtimes,
          actors, and finally the memory-ordering rules that make "correct" mean something precise.
        </p>
