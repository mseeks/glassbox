  ...
  return (
    <section className="section">
      ...
      <p className="prose">
        ...
        on IO, waiting for a database query, a file read, or a network response, holding a thread of
        resources to do nothing.
      </p>
      <p className="prose">
        Async is the architectural answer. The same code that <em>looks</em> synchronous, await this
        then do that, doesn't actually pin a thread while waiting. A small pool of threads handles
        thousands of in-flight tasks, switching between them at every IO boundary. The threads are
        precious; the tasks are cheap.
      </p>
