  ...
  return (
    <section className="section">
      ...
      <p className="prose">
        ...
        Stronger guarantees rule out more pathological scenarios. They are also correspondingly
        harder to achieve.
      </p>
      ...
      <div className="progress-stack">
        <div className="progress-row">
          ...
          <div className="progress-desc">
            ...
            may be stuck forever. Mutexes live here.
          </div>
        </div>
        <div className="progress-row">
          ...
          <div className="progress-desc">
            ...
            retry repeatedly (CAS losers), but the system as a whole never stalls. One thread can
            still lose. Worst-case latency for a single thread is unbounded.
          </div>
        </div>
        <div className="progress-row">
      ...
      <p className="prose">
        ...
        reference-counted pointers). Wait-free is rare and difficult, and it is exactly the right
        choice in the narrow case where a single hung thread becomes a missed market or a missed
        deadline. That case is rare. When it arrives, nothing weaker will do.
      </p>
      ...
      <p className="prose">
        ...
        , the fast userspace mutex. The trick: take the fast path entirely in userspace via an
        atomic CAS, and only enter the kernel when there's actually contention (a thread needs to be
        parked or woken). The result is that an uncontended <code>lock()</code>/
        <code>unlock()</code> pair is just two atomic instructions. No system call, no context
        switch.
      </p>
      <p className="prose">
        ...
        the most consequential systems-programming inventions of the last 25 years. Almost nobody
        outside kernel hackers has heard of it.
      </p>
    </section>
  );
}
