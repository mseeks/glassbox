  ...
  return (
    <section className="section">
      ...
      <p className="prose">
        ...
        that hasn't run yet, is captured as data in a future or task object, often heap-allocated by
        the runtime that schedules it. A single OS thread can be the executor for thousands of these
        state machines, advancing whichever one is ready, going back to sleep when none are.
      </p>
      <p className="prose">
        The field discovered this, lost it, then rediscovered it, over and over. Lisp had
        continuations in 1975. Python and Ruby had generators in the 2000s. C# added{' '}
        <code>async/await</code> in 2012. Today, every language with serious networking runtime has
        async/await, and they're all doing the same trick under the hood.
      </p>
    </section>
  );
}
