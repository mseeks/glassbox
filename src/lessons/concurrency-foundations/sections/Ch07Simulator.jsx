    ...
    <section className="section">
      ...
      <div className="mental-model">
        ...
        <p className="mental-model-body">
          ...
          across the room is main memory. Writes get scribbled on the clipboard first — fast, local
          — and only walked over to the bulletin board <em>eventually</em>. Two contractors can each
          scribble <span className="ink">"done"</span> on their own clipboards, glance at the
          bulletin board (still empty), and conclude nothing is finished. That is the entire bug,
          and the rest of this lesson is just precision around it.
        </p>
      </div>
      ...
      <p className="prose">
        ...
        <code>true</code>. Then flip the toggle to <strong>SeqCst</strong> and watch the same
        sequence become impossible.
      </p>
      ...
      <p className="prose">
        ...
        buffer is the mechanism; the as-if-serial rule for a single thread is preserved (each thread
        observes its own writes in order). The "impossibility" only exists in your mental model —
        not the machine's.
      </p>
    </section>
  );
