    ...
    <div style={{ maxWidth: 760 }}>
      <Prose dropcap>
        <p>
          ...
          absorbed — its own local events plus everything merged in. Light clocks are sharp; heavy
          clocks blur together.
        </p>
        <p>
    ...
    <div style={{ maxWidth: 760, marginTop: 40 }}>
      <Prose>
        <p>
          ...
          expected load; below it, errors are rare; past it, errors dominate. Unlike a Bloom filter
          — where you know up-front roughly how many items you'll insert and can size accordingly —
          a Bloom clock keeps accumulating <em>time</em>. Left alone forever, every Bloom clock will
          eventually saturate.
        </p>
