...
export const ChapterSeven = () => (
  <Section id="ch7" narrow>
    ...
    <Prose>
      <p>
        Run the logic the other way. If A and B are concurrent, with neither one causing the other,
        their counters accumulated independently. Maybe their increments landed on entirely disjoint
      ...
      <p>
        So when we see "neither dominates," some positions where A wins and some where B wins, we
      ...
      <p>
        And when we see one dominates, with A dominated by B everywhere, it's either because A
        really did happen before B, or because they're concurrent and the independence happened to
        favor B. We can't distinguish from inside the structure. That's the probabilistic error. And
