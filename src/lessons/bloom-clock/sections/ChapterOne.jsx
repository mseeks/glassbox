...
export const ChapterOne = () => (
  <Section id="ch1" narrow>
    ...
    <Prose dropcap>
      <p>
        Two computers, somewhere on a network. Each one is doing things — writing rows, sending
        messages, processing events. Now ask the most innocent-sounding question in distributed
        systems: <em>did this event happen before that one?</em>
      </p>
      <p>
      ...
      <p>
        ...
        Anything else — events with no such chain in either direction — is <em>concurrent</em>.
      </p>
      <p>
        ...
        the system either drops writes, invents fake conflicts, or — worst — silently corrupts
        state.
      </p>
    </Prose>
    ...
    <Prose>
      <p>
        ...
        heard about came after one it already knew? It can't ask anyone — there's nobody it trusts
