...
export const ChapterSix = () => (
  <Section id="ch6">
    ...
    <div style={{ maxWidth: 760 }}>
      <Prose dropcap>
        <p>
          To compare two clocks A and B, walk both arrays in parallel. At each of the m positions,
          note whether A's counter is less than, equal to, or greater than B's. After all m
          positions, one of three things will be true.
        </p>
        <p>
        ...
        <p>
          ...
          The verdict: <span style={{ color: '#6ee7b7' }}>A and B are concurrent</span>. And
          critically — this verdict is <em>exact</em>. There is no probabilistic uncertainty here,
          no false positive to worry about. We'll spend the next chapter on why.
        </p>
      </Prose>
    </div>
