  ...
  return (
    <Chapter num="06" title="The Limits" anchor="ch-06">
      ...
      <p>
        ...
        items that share that position — introducing false negatives, the one error mode we are not
        allowed. Counting Bloom filters fix this with counters; cuckoo filters fix it with
