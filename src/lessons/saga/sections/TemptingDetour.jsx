    ...
    >
      <Prose drop>
        ...
        <p>
          ...
          It can only wait. In the language of the <em>CAP theorem</em> — under a partition you may
          keep consistency or availability, not both — 2PC plants its flag firmly in consistency,
