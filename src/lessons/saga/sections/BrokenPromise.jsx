    ...
    >
      <Prose drop>
        <p>
          ...
          it touches the real data. That journal is the secret of atomicity — the <b>A</b> in{' '}
          <LessonLink to="acid-lab">ACID</LessonLink>, the promise that a group of changes either
          all happen or none do. To commit, the engine seals the journal; to abort, it discards it.
          One log, one authority, one place that decides the fate of the whole group.
        </p>
        <p>
