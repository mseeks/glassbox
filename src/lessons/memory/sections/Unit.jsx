      ...
      <div className="wrap">
        ...
        <div className="rev">
          <p className="lead" style={{ marginBottom: 16 }}>
            ...
            or <strong>off</strong>. Every photo, song, and program you have ever owned. We call
            that switch a <em className="term">bit</em>. Eight of them together make a{' '}
            <em className="term">byte</em>, and one byte is just enough to hold a single letter.
          </p>
          <p style={{ marginBottom: 24 }}>
            ...
            these rings, threaded <strong>by hand</strong> by women at looms, one bit at a time.
            Software you could literally hold and weave.
          </p>
        </div>
        <div className="rev">
          <WeaveByte />
