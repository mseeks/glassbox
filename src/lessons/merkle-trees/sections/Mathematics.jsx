  ...
  return (
    <section className="mk-section">
      ...
      <Reveal base="mk-reveal" className="mk-prose">
        ...
        <p>
          Double the dataset and the proof grows by a <em>single</em> hash. That is the entire
          reason Merkle trees scale: cost tied to the height of the structure, while the data grows
          along its width.
        </p>
      </Reveal>
      ...
      <Reveal base="mk-reveal" className="mk-prose" style={{ marginTop: 20 }}>
        <p>
          ...
          tree, with new leaves chained off one side, degrades proofs toward <code>N</code>. Real
          systems keep balance by construction, which is the seed of several variants we'll meet
          shortly.
        </p>
      </Reveal>
    </section>
