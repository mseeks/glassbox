      ...
      <div className="swim-page">
        ...
        <div className="swim-prose swim-mid" style={{ marginBottom: 40 }}>
          ...
          <p>
            ...
            <strong>k</strong> other nodes at random — usually k = 3 — and asks each of them to
            probe the target on its behalf. If even one of those indirect probes succeeds, the
            target is alive; the original failure was the network's fault, not the node's.
          </p>
          <p>
            ...
            <sup>k+1</sup> — an exponential improvement at constant per-node cost. Try it below:
            break the direct link and watch the helpers route around it.
          </p>
        </div>
        ...
        <div className="swim-prose swim-mid">
          ...
          <p>
            Why does the prober pick its target at random? Because if every node always probed the
            same neighbour, dead nodes near popular neighbours would be detected quickly and the
            unloved corners of the cluster would be probed almost never. Random selection gives{' '}
            <em>probabilistic completeness</em>: over enough rounds, every node is probed by every
            other node with high probability.
          </p>
          <p>
            ...
            reshuffle at the end. Each node has its own shuffle, preserving randomness{' '}
